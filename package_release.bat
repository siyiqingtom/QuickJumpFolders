...
rem  Output: dist\smart_upload-<version>.zip
rem ============================================================
...
echo ============================================================
echo  Packaging smart_upload %VERSION%
echo ============================================================
echo.
...
rem Step 2: stage files into dist\smart_upload-<version>\
echo.
echo [2/3] Staging files...

set STAGE=dist\smart_upload-%VERSION%
...
copy /Y dist\使用说明.txt       "%STAGE%\" >nul
...
set ZIPFILE=dist\smart_upload-%VERSION%.zip
